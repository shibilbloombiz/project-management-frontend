...
import { Layers, Briefcase, CheckSquare, Users, Clock, BarChart3, Bell, ShieldCheck, Play, ArrowLeft, Plus, Check, X, Edit, Menu } from "lucide-react";
  ...
  const loadLeadData = () => {
    ...
    fetch(`${API_BASE_URL}/api/lead/projects${q}`, {
      ...
      if (r.success) {
        setProjects(r.data);
        if (selectedProject) {
          const updated = r.data.find(p => (p._id || p.id) === (selectedProject._id || selectedProject.id));
          if (updated) {
