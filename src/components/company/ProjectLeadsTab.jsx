      ...
      <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        <div className="p-5 border-b border-slate-100 flex justify-between items-center">
          ...
          <button
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs px-3.5 py-2.5 rounded-xl flex items-center space-x-1.5 cursor-pointer transition-colors shadow-md shadow-indigo-100"
          >
            <Plus size={13} />
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 text-sm font-semibold text-slate-600">
              {projectLeads.map((lead) => (
                <tr key={lead._id || lead.email} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="py-4 px-6 text-xs font-mono font-medium text-slate-500">{lead.email}</td>
                  <td className="py-4 px-6">
                    <span className="px-2 py-0.5 text-[10px] font-bold rounded-full border bg-slate-100 text-slate-600 border-slate-200">
                  ...
                  <td className="py-4 px-6 text-right">
                    <div className="flex items-center justify-end space-x-3.5">
                      <button
                        ...
                        className="text-[10px] font-bold text-slate-500 hover:text-slate-700 hover:underline flex items-center cursor-pointer"
                      >
